...
- Safety: operation-specific Class A–D memory gates and isolated sequential children.
- Unresolved: free Colab and AI-assistant permission require organizer clarification.
- Dependencies: modelling/geospatial packages remain absent until Phase 1 establishes necessity,
